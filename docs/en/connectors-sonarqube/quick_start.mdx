        ...
        - name: sonar-scanner
          ...
          command:
            ...
            - |
              ...
              cat /scanner-config/sonar-scanner.properties >> sonar-project.properties
...
:::tip
The connector mounts a `sonar-scanner.properties` configuration file via CSI that contains scanner settings with proxy configuration. The configuration includes:
...
```
INFO: Scanner configuration file: /scanner-config/sonar-scanner.properties
