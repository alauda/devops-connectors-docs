...
#### sonar-project.properties Configuration File \{#sonar-scanner-properties-configuration-file}
...
`ca.cert` is automatically mounted by the connector and contains the CA certificate of the Connector Proxy server. More details can be found in the [Connectors CSI Built-in Configurations](../../connectors/concepts/connectors_csi.mdx#built-in-configurations).
