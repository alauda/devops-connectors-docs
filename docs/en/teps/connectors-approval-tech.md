...
# 记录 1. 审批检查的配置规则，2. 审批检查的状态 {#记录-1-审批检查的配置规则2-审批检查的状态}
status:
  conditions: []
...
# apiVersion: openshift-pipelines.org/v1alpha1 {#apiversion-openshift-pipelinesorgv1alpha1}
# kind: ApprovalRequest {#kind-approvalrequest}
# spec: {#spec}
# # ApprovalRequest Spec {#approvalrequest-spec}

# apiVersion: openshift-pipelines.org/v1alpha1 {#apiversion-openshift-pipelinesorgv1alpha1-1}
# kind: ScriptCheck {#kind-scriptcheck}
# spec: {#spec-1}
# # ScriptCheck Spec {#scriptcheck-spec}
```
