...
# Using OCI Connector Reverse Proxy to Build Images in Tekton Pipeline
...
- Specify the `registry-config` workspace as the `registry-config` configuration of the OCI connector, thereby mounting `config.json`.
