...
| config not found | Wrong mount path, missing volumes | Image pull/push operations fail |
...
|-------------------|-------------|----------|
| `registry-config` | Standard OCI client like buildkit, buildah authentication configuration | General container operations |
