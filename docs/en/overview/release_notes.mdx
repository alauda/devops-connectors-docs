...
- The permission validation model for the Connectors API and Proxy has been updated. 
  - When calling the Connectors API, the user must have the connectors/apis permission. 
  - When calling the Connectors Proxy, the user must have the connectors/proxy permission.
