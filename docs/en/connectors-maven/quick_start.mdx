...
- Kubernetes cluster with Connectors system installed (Operator, ConnectorsCore and ConnectorsMaven components). See the [Installation Guide](../install/install.mdx) for details on installing these components.
