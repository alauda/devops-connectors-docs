...
:::info
This scenario requires enabling the `enable-multi-connector` feature flag on `ConnectorsConfig`. For details, see [Feature Flags](../../overview/feature_flags.mdx#enable-multi-connector).
:::
